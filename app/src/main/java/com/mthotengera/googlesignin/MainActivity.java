package com.mthotengera.googlesignin;
...
public class MainActivity extends FragmentActivity implements ConnectionCallbacks, OnConnectionFailedListener, View.OnClickListener {
    ...
    public void onConnected(Bundle bundle) {
        ...
        try {
            ...
            Log.d("MainActivity -> onConnected method ", ex.getLocalizedMessage() + ex.toString());
        }
    }
    ...
    private void resolveSignInError() {
        if (mSignInIntent != null) {
            ...
            Log.d("MainActivity", " -> resolveSignInError Play Service error ");
        }
    }
